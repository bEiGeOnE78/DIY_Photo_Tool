    ...
    def extract_exiftool_metadata(self, file_path: str) -> Dict[str, Any]:
        ...
        try:
            ...
            cmd = [
                ...
                "-DateTimeOriginal", "-Make", "-Model", "-LensModel", "-LensMake", "-LensID",
        ...
        try:
            ...
            if exiftool_data:
                ...
                metadata.update({
                    ...
                    'lens_model': exiftool_data.get('LensModel') or exiftool_data.get('LensID'),
            ...
            try:
                ...
                if exif:
                    ...
                    metadata.update({
                        ...
                        'lens_model': exiftool_data.get('LensModel') or exiftool_data.get('LensID') or exif_dict.get('LensModel'),
